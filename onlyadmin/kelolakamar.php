            ...
            <td>
              <span class="custom-checkbox">
                ...
                <label for="checkbox1"></label>
                        ...
                        <td>Single</td>
                        <td>150000/Tahun</td>
                        <td>Kamar mandi bersama tiap lantai, Wi-Fi, Ruang TV</td>
                        <td>1</td>
                        <td>80</td>
                        <td>
                        ...
                        <td><a href="#deleteEmployeeModal" class="btn btn-warning" data-toggle="modal"><i class="glyphicon glyphicon-download"></i> <span>Delete</span></a>
                        </td>  
                    </tr>
                    <tr>
            <td>
      ...
      <div class="modal-content">
        <form>
          ...
          <div class="modal-body">          
            ...
            <div class="form-group">
              <label>No Kamar</label>
              <input type="text" class="form-control" required placeholder="K001">
            </div>
            <div class="form-group">
              <label>Jenis Kamar</label>
              <select name="cicilan">
            ...
            <div class="form-group">
              <label>Harga Kamar</label>
              <input type="text" class="form-control" required placeholder="150000/Tahun">
            </div>
            <div class="form-group">
              <label>Fasilitas Kamar</label>
              <input type="text" class="form-control" required placeholder="Kamar mandi dalam">
            </div>
            <div class="form-group">
              <label>Lantai</label>
              <select name="cicilan">
            ...
            <div class="form-group">
              <label>Kuota Kamar</label>
              <input type="text" class="form-control" required placeholder="80">
            </div>           
          </div>
          <div class="modal-footer">
            <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
