          ...
          <div class="card border border-light rounded-7">
                <div class="card-header p-0">
                  <div class="bg-info text-white text-center py-2">
                    <h3 style="color:white;">Data Kontak</h3>
                  </div>
                </div>
            ...
            <div class="card-body p-3">
              <div class="form-row">
                <div class="col">
                  ...
                  <input class="form-control" type="text" placeholder="ex: A" id="penjaga">
                </div>
              </div>
              <div class="form-row">
                <div class="col">
                  <label for="gedung">Gedung</label>
                  <input class="form-control" type="text" placeholder="ex : A" id="gedung" required>
                </div>
              </div>
              <div class="form-row">
                <label for="notelp">Nomor Telepon</label>
                <input class="form-control" type="notelp" placeholder="ex: 08xxxxxxxxxx" id="notelp" required>
              </div>
            </div>
