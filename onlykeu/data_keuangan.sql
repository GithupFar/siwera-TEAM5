...
--
-- Host: 127.0.0.1
-- Generation Time: 03 Des 2018 pada 02.08
...
CREATE TABLE `data_keuangan` (
  ...
  `p_nrp` int(15) NOT NULL,
  `pb_status` smallint(6) NOT NULL
...
INSERT INTO `data_keuangan` (`pb_id`, `pm_id`, `p_nrp`, `pb_status`) VALUES
(1, 12, 5116037, 1),
(2, 5, 511610036, 0),
(3, 3, 511632, 1);
