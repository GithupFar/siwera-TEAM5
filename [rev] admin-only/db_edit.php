...
<div class="container d-flex justify-content-center">
	<div class="my-4">
        <div class="card">
            <div class="card-body">
		  <form method="post" action="db_edit_update.php" enctype='multipart/form-data'>
			  ...
			  <textarea name="teks" required="required" class="form-control" id="teks" rows="3"><?php echo $_GET['teks']?></textarea>
			  </div>
			  <div class="form-group">
